...
```{r plot_density_profiles, fig.cap="Overview density profiles at stations (P01-P14) and cruise dates (ID). Horizontal lines indicate determined MLD"}
...
```{r NCP_penetration_depth_calculation}
...
```{r plot_NCP_penetration_depth_and_MLD}
