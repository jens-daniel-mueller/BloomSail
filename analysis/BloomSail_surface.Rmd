...
```{r MLD_iCT_time_series, fig.asp=1}
...
# C~T~ profile reconstruction

## Read data

```{r CT_recon_read_ts_data}
...
```{r CT_recon_CT_and_temperature_changes_in_surface}
...
```{r CT_recon_incremental_changes_profiles_calculation}
...
```{r CT_recon__cumulative_changes_profiles_calculation}
...
```{r CT_recon_incremental_changes_profiles}
...
```{r CT_recon_cumulative_changes_profiles}
...
```{r CT_recon_hovmoeller_daily, fig.cap="Hovmoeller plots of daily reconstructed changes in C~T~ and temperature.", fig.asp=0.5}
...
```{r CT_recon_hovmoeller_cum, fig.cap="Hovmoeller plots of daily reconstructed changes in C~T~.", fig.asp=0.5}
...
```{r zeff_iCT_time_series, fig.asp=1}
