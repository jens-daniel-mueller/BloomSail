...
ggsave(here::here("output/Plots/Figures_publication/appendix", "tau_fit_example.png"),
       width = 180, height = 90, dpi = 300, units = "mm")
...
rm(i_ID, i_station, i_tau_factor)
...
```{r cast_tau_with_minimum_offfset}
...
A tau factor of `r tau_factor_min` resulted in the lowest absolute mean offset (`r pCO2_delta_mean_min` µatm) and will be used for response time correction.
