...
pdf(file=here::here("docs/figure",
...
A pdf with plots of all individual response time fits can be accessed [here](docs/figure/response_time.Rmd/RT_determination.pdf)
