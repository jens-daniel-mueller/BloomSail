...
ggsave(
  here::here(
    "output/Plots/Figures_publication/appendix",
    "pCO2_RT_corrected_profile_example.pdf"
  ),
  width = 100,
  height = 140,
  dpi = 300,
...
ggsave(
  here::here(
    "output/Plots/Figures_publication/appendix",
    "pCO2_RT_corrected_profile_example.png"
  ),
  width = 100,
  height = 140,
  dpi = 300,
...
Summary metric are restricted to profiles that did not exceed a maximum sampling depth of `r parameters$RT_stats_dep_max` m and pCO2 of `r parameters$RT_stats_pCO2_max` µatm.
