...
### CT_star sensitivity to AT

```{r CT_star_profiles_delta, fig.cap="Mean vertical profiles per cruise day across all stations."}
...
```{r CT_star_profiles_individual_pub_V1, fig.cap="Mean vertical profiles per cruise day across all stations plotted indivdually. Ribbons indicate the standard deviation observed across all profiles at each depth and transect.", fig.asp=1.5}
...
```{r CT_star_profiles_individual_pub_V2, fig.cap="Mean vertical profiles per cruise day across all stations plotted indivdually. Ribbons indicate the standard deviation observed across all profiles at each depth and transect.", fig.asp=1.5}
...
```{r pub_fig_CT_star_tem_hov_abs_profiles_cum, include=FALSE}
...
```{r iCT_star_fixed_depth_time_series, fig.asp=1.1}
