...
The alkalinity-normalized C~T~, C~T~*, was calculated.

```{r nCT_bottle_calculation}

# calculate CT*, referred to as nCT in the code
tb <- tb %>% 
...
```{r bottle_CO2_profiles_mean, fig.cap="Discrete sample profiles as the mean of individual stations"}
