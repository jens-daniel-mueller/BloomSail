...
Mean seawater C~T~* were calculated for 5m depth intervals, based on two A~T~ values (regular mean + 2 SD).
...
Both approaches deliver depth-integrated, incremental changes of C~T~* between cruise dates. Those were summed up to derive a trajectory of cumulative integrated C~T~* changes.
