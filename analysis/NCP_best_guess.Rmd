...
```{r plot_hovmoeller_absolut_plus_cum_profiles, fig.cap="Hovmoeller plotm of absolute changes in C~T~ and temperature, combined with profile plots of cumulative changes."}
