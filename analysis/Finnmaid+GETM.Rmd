...
fixed_values <- 
  read_csv(here::here("Data/_summarized_data_files", "BloomSail_fixed_values.csv"))
...
CT_tem %>% 
  ...
  geom_point(aes(dtem, dCT, fill=as.numeric(date)), shape=21)+
