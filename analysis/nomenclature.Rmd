...
Github repo
Explain subsetting of deployments
Explain metadata creation

CT dynamics 
Map data preparation in read-in file

Reconstruction 
fm + gt in read_in und merging section
implement exact subsetting coordinated for getm data

Open questions
Los Gates data correction
