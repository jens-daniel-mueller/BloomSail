...
CTD %>% 
  create_report(output_dir = "docs/reports/", output_file = "CTD_EDA_report.html")

```


The output of an automated Exploratory Data Analysis (EDA) performed with the package `DataExplorer` can be accessed [here](https://jens-daniel-mueller.github.io/BloomSail/docs/CTD_EDA_report.html){target="_blank}
