...
A second post-processed HydroC pCO~2~ data set was provided by KM Contros after applying a drift correction to the cleaned raw data, i.e. those without data recorded during configuration and testing of the sensor. The post-processing was still based on pre- and post-deployment calibration results. 
...
```{r read_th_post_processed_by_manufacturer_with_AW, eval=FALSE, include=FALSE}

# Read Contros corrected data file, based on cleaned recordings and 
# with water vapor correction
...
```{r compare_processed_hc_files, fig.asp=5, eval=FALSE, include=FALSE}
