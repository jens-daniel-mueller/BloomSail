...
#   
#   for (zerID in unique(ts_th_dep$Zero_ID)) {
#     
#     ts_th_dep %>%
...
ts_th %>% 
  write_csv(here::here("Data/_merged_data_files", "ts_th.csv"))
...
ts_th <- read_csv(here::here("data/_merged_data_files",
                          "ts_th.csv"),
...
tm %>% write_csv(here::here("Data/_merged_data_files",
                            "tm.csv"))
