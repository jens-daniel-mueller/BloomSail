...
A revised post-processed HydroC pCO~2~ data set was provided by KM Contros after applying a drift correction to the cleaned raw data, i.e. those without data recorded during configuration and testing of the sensor. The post-processing was still based on pre- and post-deployment calibration results. 
...
ggplot() +
  geom_path(data = ts_th_sub,
            aes(date_time, pCO2_corr, col = "HydroC, drift corrected")) +
  geom_path(data = ts_th_sub,
