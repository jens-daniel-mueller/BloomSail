...
Approach: Determine the depth across which most of the iCT signal was observed after the initial production pulse on July 23. Thereafter, restrict calcualtion of cummulative CT changes to that depth.

```{r integrated_iCT_first_pulse}
...
```{r depth_distribution_iCT_180723}
...
iCT_dep %>% 
  ...
  geom_point()+
  geom_line()+
  labs(x="Depth (m)", y = "Relative contribution to iCT on July 23")+
  ylim(0,100)+
  theme_bw()
...
90% of the cumulative iCT observed until July 23 is observed and homogeniouly spread across the upper ten metres of the water column. The intial idea to restrict ongoing CT changes after July 23 to the depth were most of the iCT signal was located is stopped here, as it would lead to the exact same result as the intergration over the upper 10 m of the water column executed above. 
