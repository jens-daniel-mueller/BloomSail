...
# hist(EGS$MODIS_2018_07_26_EGS.1_s)
# hist(EGS$MODIS_2018_07_26_EGS.2_s)
# hist(EGS$MODIS_2018_07_26_EGS.3_s)
...
```{r nCT_profiles_individual_pub_V1, fig.cap="Mean vertical profiles per cruise day across all stations plotted indivdually. Ribbons indicate the standard deviation observed across all profiles at each depth and transect.", fig.asp=1.5}
...
```{r nCT_profiles_individual_pub_V2, fig.cap="Mean vertical profiles per cruise day across all stations plotted indivdually. Ribbons indicate the standard deviation observed across all profiles at each depth and transect.", fig.asp=1.5}
...
[pdf here](https://github.com/jens-daniel-mueller/BloomSail/tree/master/output/Plots/CT_dynamics/tm_profiles_pCO2_tem_sal_CT.pdf){target="_blank"} 
and grouped by ID 
[pdf here](https://github.com/jens-daniel-mueller/BloomSail/tree/master/output/Plots/CT_dynamics/tm_profiles_ID_pCO2_tem_sal_CT.pdf){target="_blank"}. The later gives an idea of the differences between stations at one point in time.
...
p_nCT_hov <- tm_profiles_ID_long %>%
  ...
  scale_fill_scico(
    breaks = MakeBreaks(bin_nCT),
    guide = "colorstrip",
    name = expression(atop(paste(C[T],"*"),
                           (µmol ~ kg ^ {
                             -1
                           }))),
    palette = "davos",
...
((p_tem_hov | p_tem_ID_cum ) + plot_layout(tag_level = 'new', widths = c(2, 0.9))) / 
((p_nCT_hov | p_nCT_ID_cum ) + plot_layout(tag_level = 'new', widths = c(2, 0.9))) +
