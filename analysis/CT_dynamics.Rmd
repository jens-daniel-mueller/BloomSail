...
tm_profiles_surface_long_ID %>%
  filter(var == "nCT") %>% 
  ggplot()+
  geom_point(data = tb_surface_ID %>% filter(var == "CT_AT_ratio"),
             aes(x = date_time_ID,
                 y = value_mean*AT_mean,
                 color = "discrete")) +
  geom_linerange(data = tb_surface_ID %>% filter(var == "CT_AT_ratio"),
             aes(x = date_time_ID,
                 ymin = value_mean*AT_mean - value_sd*AT_mean,
                 ymax = value_mean*AT_mean + value_sd*AT_mean,
                 color = "discrete"))+
