...
Total incremental C~T~ changes inbetween cruise dates were calculated for 5m depth intervals.
...
Cumulative C~T~ changes were calculated for 5m depth intervals.

```{r plot_integrated_NCP_timeseries_cumulative}
