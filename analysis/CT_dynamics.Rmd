...
Timeseries of changes in seawater vars were calculated for 5m depth intervals.
...
```{r plot_hovmoeller_daily, fig.cap="Hovmoeller plots of daily changes in C~T~ and temperature."}
...
Incremental and cumulative C~T~ changes inbetween cruise dates were integrated across the water colums down to predefined depth limits.
