...
```{r heat_penetration_depth_comparison, fig.asp=0.5}
...
```{r tem_hovmoeller_daily, fig.cap="Hovmoeller plots of modelled daily changes in temperature.", fig.asp=0.5}
...
```{r CT_hovmoeller_daily, fig.cap="Hovmoeller plots of daily reconstructed changes in C~T~.", fig.asp=0.5}
...
```{r plot_hovmoeller_cum, fig.cap="Hovmoeller plots of cumulative reconstructed changes in C~T~.", fig.asp=0.5}
